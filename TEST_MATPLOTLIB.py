...
def get_BTempimage_bound(latmin,latmax,lonmin,lonmax):
    BTempimage = xr.open_dataset(IRDIR+ "IRimages2012/merg_2012080100_4km-pixel.nc4")
...
Hfile_label = h5py.File(IRDIR + TC_serial + r"_" + I_name + r'_thejudgement.h5','w')
Hfile_label.close()

Hfile_label = h5py.File(IRDIR + TC_serial + r"_" + I_name + r'_thejudgement.h5','r+')
