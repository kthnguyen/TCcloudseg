...
SAVDIR = WORKPLACE + r"\3_Figures\ERNESTO_NEW_NO500"
...
#%%
Hfile_label = h5py.File(TC_serial + r"_" + I_name + r'_thejudgement_NO500.h5','w')
Hfile_label.close()

Hfile_label = h5py.File(TC_serial + r"_" + I_name + r'_thejudgement_NO500.h5','r+')
    ...
    for props in regions_core:
        if props.label >0:
            ...
            if prop_volume > C_flag_core_volume*0.2:
                if distance_from_centre < min_distance_from_centre:
                    min_distance_from_centre = distance_from_centre
                    chosen_prop = props
